            ...
            <div class="col-md-12">
                <div class="title-box ttm-textcolor-white">
                    <div class="page-title-heading">
                        <h1 class="title">Announcement Detail</h1>
                    ...
                    <article class="post ttm-blog-classic">
                        ...
                        <div class="featured-imagebox featured-imagebox-post">
                            <div class="featured-thumbnail">
                                <img class="img-fluid" src="{{ asset(imagePath($announcement->image, 'announcements')) }}" alt="{{ $announcement->title }}">
...
@section('meta_elements')
    @include('frontend.partials._meta', [
        'title' => $announcement->meta_title,
        'tags' => $announcement->meta_tags,
        'description' => $announcement->meta_description
    ])
@endsection