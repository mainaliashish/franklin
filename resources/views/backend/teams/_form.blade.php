          ...
          <div class="form-group">
              ...
              {!! Form::text('contact', $team->contact ?? '' , ['class' => 'form-control','placeholder'=>'Enter team
              contact']) !!}
          </div>

          <div class="form-group">
              {!! Form::label('address', 'Team Address : ', ['class' => 'font-weight-bold']) !!}
              {!! Form::text('address', $team->address ?? '' , ['class' => 'form-control','placeholder'=>'Enter team
              address']) !!}
          </div>

          <div class="form-group">
              {!! Form::label('email', 'Team Email : ', ['class' => 'font-weight-bold']) !!}
              {!! Form::text('email', $team->email ?? '' , ['class' => 'form-control','placeholder'=>'Enter team
              email']) !!}
          </div>

          <div class="form-group">
              {!! Form::label('facebook', 'Team Facebook : ', ['class' => 'font-weight-bold']) !!}
              {!! Form::text('facebook', $team->facebook ?? '' , ['class' => 'form-control','placeholder'=>'Enter team
              facebook']) !!}
          </div>

          <div class="form-group">
              {!! Form::label('twitter', 'Team Twitter : ', ['class' => 'font-weight-bold']) !!}
              {!! Form::text('twitter', $team->twitter ?? '' , ['class' => 'form-control','placeholder'=>'Enter team
              twitter']) !!}
          </div>
          ...
          <div class="form-group">
              ...
              {!! Form::text('meta_title', $blog->meta_title ?? '' , ['class' => 'form-control','placeholder'=>'Enter
              blog meta title']) !!}
          </div>

          <div class="form-group">
              {!! Form::label('meta_tags', 'Blog Meta tags : ', ['class' => 'font-weight-bold']) !!}
              {!! Form::text('meta_tags', $blog->meta_tags ?? '' , ['class' => 'form-control','placeholder'=>'Enter blog
              meta tags']) !!}
          </div>
