          ...
          <nav class="mt-2">
              <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
               ...
               with font-awesome or any other icon font library -->
                ...
                <li class="nav-item">
                    <a href="" class="nav-link {{ request()->routeIs('backend.events*') ? 'active' : '' }}">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('backend.events.create') }}" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Create Event</p>
                            </a>
                        </li>
                ...
                <li class="nav-item">
                    <a href="" class="nav-link {{ request()->routeIs('backend.results*') ? 'active' : '' }}">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{ route('backend.results') }}" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>All results</p>
                            </a>
                        </li>
                ...
                <li class="nav-item">
                    <a href="" class="nav-link {{ request()->routeIs('backend.studyabroads*') ? 'active' : '' }}">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{ route('backend.studyabroads') }}" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>All Studies</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('backend.studyabroads.create') }}" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Create Study Abroad</p>
                            </a>
                        </li>
                    </ul>
                </li>
                <li class="nav-item">
                    <a href="" class="nav-link {{ request()->routeIs('backend.testpreparations*') ? 'active' : '' }}">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{ route('backend.testpreparations') }}" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>All Test</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('backend.testpreparations.create') }}" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Create New Test Info</p>
                            </a>
                        </li>
                    </ul>
                </li>
